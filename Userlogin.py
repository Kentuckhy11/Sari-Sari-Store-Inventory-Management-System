...
class Login:
    ...
    def __init__(self):
        ...
        self.loginw.config(bg="navajowhite3")
        Label(self.loginw, text="Prototype", bg="navajowhite3").pack(anchor='center', side="top")
        Label(self.loginw, text="Sari Sari Store Inventory Management System", font=('Helvetica', 15), bg="navajowhite3").pack(anchor='center', side="top")
        self.logintable()
    ...
    # WIDGET FUNCTION
    def obj(self):
        self.loginframe=LabelFrame(self.loginw,bg="navajowhite2",height=400,width=300)
        self.loginw.bind('<Return>',self.checkuser)
        self.loginframe.place(x=103,y=95)
        self.toplabel = Label(self.loginframe, fg="black", bg="navajowhite2", anchor="center", text="LOG IN", font=("Constantia", 30))
        self.toplabel.place(x=75,y=25)
        self.us = ttk.Entry(self.loginframe, width=20, textvariable=self.username,font="Helvetica ")
        self.us.place(x=35,y=145,height=40)
        self.pa = ttk.Entry(self.loginframe, width=20, textvariable=self.password,font="Helvetica ")
        self.pa.place(x=35,y=185,height=40)
        self.us.bind('<Button-1>', self.onclick)
        self.pa.bind('<Button-1>', self.onclick1)
        self.signin = Button(self.loginframe,width=20, text="Sign in",bg="snow",fg="gray7",command=self.checkuser,font="Helvetica")
        self.signin.place(x=35,y=290)   
     #  self.register = Button(self.loginframe,width=20, text = "Register",bg="snow",fg="dimgray",command = self.reguser,font="Roboto")
    ...
    def reguser(self):
       ...
       # ADD
        self.register = Button(self.loginframe,width=20, text = "Back",bg="snow",fg="dimgray",command = self.revert,font="Helvetica")
        self.register.place(x=35,y=320)
