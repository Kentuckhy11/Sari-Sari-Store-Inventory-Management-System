...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="navajowhite3")
        self.topframe.place(x=0,y=0)
        self.store_name = 'Sari Sari Store'
        self.storelable=Label(self.topframe,text = self.store_name + " Inventory Management System",bg="navajowhite3", anchor="center")
